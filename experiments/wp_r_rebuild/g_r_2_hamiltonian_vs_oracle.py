...
Threshold and configuration set are in docs/protocol.md section 3 and revision 2, both committed
...
# Registered in docs/protocol.md revision 2.
...
def main() -> int:
    ...
    path = write_gate_record(
        ...
        threshold={
            ...
            "registered_in": "docs/protocol.md section 3, configuration set in revision 2",
        },
        measured=measured,
        passed=passed,
        cases=cases,
