...
Thresholds are in GATES.md section 3 and Amendment 9, committed before this ran.
...
# Registered in GATES.md Amendment 9.
MU = 0.20
SIZES = [4, 6, 8, 10, 12]
N_COUPLINGS = 2
NK_SIZES = [4, 6, 8]
...
def main() -> int:
    ...
    path = write_gate_record(
        ...
        threshold={
            ...
            "registered_in": "GATES.md section 3, families in Amendment 9",
        },
        measured=measured,
        passed=passed,
        cases=cases,
