...
Threshold and case set are registered in GATES.md section 3 and Amendment 1, both committed
...
# Registered in GATES.md Amendment 1.
...
def main() -> int:
    ...
    path = write_gate_record(
        ...
        threshold={
            ...
            "value": THRESHOLD,
            "registered_in": "GATES.md section 3, case set in Amendment 1",
        },
        measured=measured,
        passed=passed,
        cases=cases,
