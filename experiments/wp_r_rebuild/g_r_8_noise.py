...
Thresholds and configurations are in GATES.md section 3 and Amendment 10, committed before
this ran.
...
# Registered in GATES.md Amendment 10.
MU = 0.20
SIZES = [2, 3, 4]
SHOTS = 40000
...
def main() -> int:
    ...
    path = write_gate_record(
        ...
        threshold={
            ...
            "registered_in": "GATES.md section 3, configurations in Amendment 10",
        },
        measured=measured,
        passed=passed,
        cases=cases,
