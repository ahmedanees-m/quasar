...
| `quickstart.md` | First check run, start to finish |
...
| `validation.md` | The check system, the conventions, and the failure modes each one locks |
...
that relies on it. A property asserted in code but not derived here fails check G-1.3.
